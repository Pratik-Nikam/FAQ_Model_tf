# Save the model
model_for_inference.save("arxiv_text_classifier.h5")


from tensorflow.keras.models import load_model

# Load the model
loaded_model = load_model("arxiv_text_classifier.h5")
...
# Preprocess the new text data (if necessary)
# Since the model includes the TextVectorization layer, you can directly pass raw text
...
# Access the TextVectorization layer and vocabulary
